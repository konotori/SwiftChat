...
class FirebaseUserListener {
    ...
    func loginUserWithEmal(email: String, password: String, completion: @escaping (_ error: Error?, _ isEmailVerified: Bool) -> Void) {
        ...
        Auth.auth().createUser(withEmail: email, password: password) { authDataResult, error in
            ...
            if error == nil {
                ...
                if authDataResult?.user != nil {
                    let user = User(id: authDataResult!.user.uid, username: email, email: email, pushId: "", avatarLink:
